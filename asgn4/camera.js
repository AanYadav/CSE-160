class Camera {
    constructor(canvas) {
        this.fov = 60;
        // Start inside the world so the bounding walls don't block the view
        this.eye = new Vector3([16, 5, 2]);     // elevated, inside the north wall
        this.at  = new Vector3([16, 2, 16]);    // looking toward world centre
